...
#define RPI4HDMIWAV_VERSION               1

// Revision number.
#define RPI4HDMIWAV_REVISION              0

// Product Id
// {DCA49BAE-8129-4901-91E2-BAF50AF71D96}
#define STATIC_PID_RPI4HDMIWAV\
    0xdca49bae, 0x8129, 0x4901, 0x91, 0xe2, 0xba, 0xf5, 0x0a, 0xf7, 0x1d, 0x96
DEFINE_GUIDSTRUCT("DCA49BAE-8129-4901-91E2-BAF50AF71D96", PID_RPI4HDMIWAV);
#define PID_RPI4HDMIWAV DEFINE_GUIDNAMED(PID_RPI4HDMIWAV)

// Pool tag used for RPI4HDMIWAV allocations
#define RPI4HDMIWAV_POOLTAG               '2IPR'  

// Debug module name
#define STR_MODULENAME              "RPI4HDMIWAV: "
