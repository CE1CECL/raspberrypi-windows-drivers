...
NTSTATUS
CreateMiniportTopologyRPI4HDMIWAV
( 
...
--*/
{
    ...
    return CMiniportTopologyRPI4HDMIWAV::GetDescription(OutFilterDescriptor);
} 
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyRPI4HDMIWAV::Init failed, 0x%x", ntStatus)),
        Done);
