...
NTSTATUS
CreateMiniportTopologyRPIHDMI0WAV
( 
...
--*/
{
    ...
    return CMiniportTopologyRPIHDMI0WAV::GetDescription(OutFilterDescriptor);
} 
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyRPIHDMI0WAV::Init failed, 0x%x", ntStatus)),
        Done);
