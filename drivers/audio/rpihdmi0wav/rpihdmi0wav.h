...
#define RPIHDMI0WAV_VERSION               1

// Revision number.
#define RPIHDMI0WAV_REVISION              0

// Product Id
// {DCA49BAE-8129-4901-91E2-BAF50AF71D96}
#define STATIC_PID_RPIHDMI0WAV\
    0xdca49bae, 0x8129, 0x4901, 0x91, 0xe2, 0xba, 0xf5, 0x0a, 0xf7, 0x1d, 0x96
DEFINE_GUIDSTRUCT("DCA49BAE-8129-4901-91E2-BAF50AF71D96", PID_RPIHDMI0WAV);
#define PID_RPIHDMI0WAV DEFINE_GUIDNAMED(PID_RPIHDMI0WAV)

// Pool tag used for RPIHDMI0WAV allocations
#define RPIHDMI0WAV_POOLTAG               '2IPR'  

// Debug module name
#define STR_MODULENAME              "RPIHDMI0WAV: "
